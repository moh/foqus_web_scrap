...
class CustomProxyMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        #    request.headers[x] = self.headers[x]
        ...
        if self.nb_requests == self.settings.get("TOR_NUMBER_REQUEST_CHANGE_IP"):
            ...
            self.nb_requests = 0
            request.headers["User-Agent"] = 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:77.0) Gecko/20100101 Firefox/77.0' #self.user_rotator.get_random_user_agent()
            self._set_new_ip()
        self.nb_requests += 1    
